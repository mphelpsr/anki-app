...
- [x] T032 **Cancelado, não adiado** — decisão de produto: não perseguir a licença Oxford (mesmo para uso pessoal, os termos de uso do Oxford Learner's Dictionaries não permitem copiar/redistribuir o material sem permissão por escrito, nem a lista "de referência" em PDF). Substituído por conteúdo 100% autoral: `src/content/seed/core-vocabulary-{a1,a2,b1}.json`, 20 cartas por nível (60 no total), escrito do zero — ver `content-pipeline/SOURCES.md`
