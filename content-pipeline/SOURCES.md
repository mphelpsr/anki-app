...
## `core-vocabulary-a2.json`, `core-vocabulary-b1.json`
...
- **Fonte**: Conteúdo original, redigido para este projeto — **não** é
  ...
  reflete conhecimento geral e público de progressão lexical no ensino
  de inglês, não uma lista curada de terceiros.
- **Status de licença**: N/A (conteúdo original, de autoria do próprio
  projeto).
- **Nível declarado**: A2 e B1 respectivamente — classificação editorial
  própria, não corresponde a uma certificação CEFR formal de nenhuma
  fonte externa.
- **Data de criação**: 2026-08-08.
- **Quantidade**: 20 cartas por nível (40 no total). `core-vocabulary-a2.json`
...
- **A1 deliberadamente fora**: um deck `core-vocabulary-a1.json` (20
  cartas) chegou a ser criado e semeado, mas foi removido a pedido do
  aprendiz — vocabulário considerado básico demais, conhecimento que já
  tem. O app parte de A2.
